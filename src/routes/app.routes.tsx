...
export function AppRoutes() {
  return (
    <Navigator screenOptions={{ headerShown: false }}>
      ...
      <Screen name="homestats" component={Homestats} />

      <Screen name="mealcreator" component={MealCreatorPage} />
      <Screen name="mealeditor" component={MealEditorPage} />

      <Screen name="feedback" component={FeedBackPage} />

      <Screen name="mealinfo" component={MealPageInfo} />
    </Navigator>
  );
}
