...
export const ButtonYes = styled(TouchableOpacity)<buttonProps>`
  ...
  border: 2px
    ${({ theme, isSelected }) =>
      isSelected ? theme.COLORS.GREEN_MID : theme.COLORS.GRAY_5};
  background-color: ${({ theme, isSelected }) =>
    isSelected ? theme.COLORS.GREEN_LIGHT : theme.COLORS.GRAY_5};
`;
...
export const ButtonNo = styled(TouchableOpacity)<buttonProps>`
  ...
  border: 2px
    ${({ theme, isSelected }) =>
      isSelected ? theme.COLORS.RED_MID : theme.COLORS.GRAY_5};
  background-color: ${({ theme, isSelected }) =>
    isSelected ? theme.COLORS.RED_LIGHT : theme.COLORS.GRAY_5};
`;
